                ...
                try {
                    ...
                    if (buttonText === "Save as Text File") {
                        ...
                        chrome.windows.create({
                            url: chrome.runtime.getURL("popup/restore.html"),
                            type: "popup",
                            width: 400,
                            height: 300
                        });
...
function saveAsTextFile() {
    ...
    if (!chrome.tabs) {
        ...
        alert("chrome.tabs not available - check permissions");
        return;
    }
    ...
    chrome.tabs.query({currentWindow: true}, function(tabs) {
        ...
        if (chrome.runtime.lastError) {
            ...
            alert("Error getting tabs: " + chrome.runtime.lastError.message);
            return;
        }
