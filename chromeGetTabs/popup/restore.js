...
function createNewWindow(urls) {
    ...
    chrome.windows.create(windowOptions, function(newWindow) {
        console.log("chrome.windows.create callback executed");
        
        if (chrome.runtime.lastError) {
            console.error("Error creating window:", chrome.runtime.lastError);
            result.innerText = `Error creating new window: ${chrome.runtime.lastError.message}`;
            return;
        }
        ...
        //         if (chrome.runtime.lastError) {
        //             console.error(`Error creating tab ${i + 1}:`, chrome.runtime.lastError);
        //             errors++;
        //         } else {
        ...
        //             result.innerText = `Opened ${successCount} out of ${urls.length} tabs in new window`;
        //             window.close();
        //         }
        //     });
        // }
